...
class KCFinder extends \yii\widgets\InputWidget
{
    ...
    {
        parent::init();
        $this->kcfOptions['uploadURL'] = ArrayHelper::getValue($this->kcfOptions, 'uploadURL', '@web/uploads');
        $this->kcfOptions['uploadDir'] = ArrayHelper::getValue($this->kcfOptions, 'uploadDir', '@app/web/uploads');
