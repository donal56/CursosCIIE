...
CREATE TABLE `cur_imagenes`  (
  ...
  CONSTRAINT `ima_fkcurso` FOREIGN KEY (`ima_fkcurso`) REFERENCES `cur_curso` (`cur_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `cur_participante`  (
  ...
  CONSTRAINT `par_fkcurso` FOREIGN KEY (`par_fkcurso`) REFERENCES `cur_curso` (`cur_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `cur_participante` VALUES (15, 'Hijo de ceci', 'ceci', 'ceci', 'H', '9933530259', 'computo@itvillahermosa.edu.mx', 18, 'cetis 70', 0, NULL, 4, NULL, 'facebook');
INSERT INTO `cur_participante` VALUES (16, 'Sergio Daniel', 'Jimenez', 'Zacarias', 'H', '9935907735', 'hmaforsiv@gmail.com', 21, 'INSTITUTO TECNOLÓGICO DE VILLAHERMOSA', 0, NULL, 4, NULL, 'por la pagina del tec');
INSERT INTO `cur_participante` VALUES (17, 'Carlos Donaldo', 'Ramón', 'Gómez', 'H', '9932978261', 'donal_56@hotmail.com', 21, 'Instituto tecnológico de Villahermosa', 0, NULL, 4, NULL, 'Mediante el facebok del ITVH');
...
INSERT INTO `user_visit_log` VALUES (213, '5db8aa2d3185b', '127.0.0.1', 'es', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36', 1, 1572383277, 'Chrome', 'Windows');
